    ...
    return (
        <div className="d-flex align-items-stretch" id="kt_app_header_menu_wrapper">
            <div className="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="app-header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_app_body', lg: '#kt_app_header_menu_wrapper'}">
                <div className="menu menu-rounded menu-column menu-lg-row menu-active-bg menu-title-gray-600 menu-state-gray-900 menu-arrow-gray-500 fw-semibold fw-semibold fs-6 align-items-stretch my-5 my-lg-0 px-2 px-lg-0" id="#kt_app_header_menu" data-kt-menu="true" style={{gap:"2rem"}}>
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" data-kt-menu-offset="-250,0" className="menu-item here show menu-here-bg menu-lg-down-accordion me-0 me-lg-2">
                        ...
                        <span className="menu-link">
                            <i className="ki-outline ki-category fs-3" style={{ marginRight: ".3rem", fontSize:".9rem" }}></i>
                            <Link to="/"><span className="menu-title" style={{fontSize:"1.1rem"}}>Dashboard</span></Link>
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" data-kt-menu-offset="-400,0" className="menu-item menu-lg-down-accordion me-0 me-lg-2">
                        ...
                        <span className="menu-link">
                            <i className="bi bi-wallet2 fs-2" style={{marginRight:".3rem", fontSize:".9rem"}}></i>
                            <span className="menu-title" style={{fontSize:"1.1rem"}}>Wallet</span>
                            <span className="menu-arrow d-lg-none"></span>
                        </span>
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" data-kt-menu-offset="12,0" className="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                        ...
                        <span className="menu-link">
                        <i className="bi bi-collection fs-2" style={{marginRight:".3rem", fontSize:".9rem"}}></i>
                            <Link to="/transactions">
                                <span className="menu-title" style={{fontSize:"1.1rem"}}>Transactions</span>
                            </Link>
                    ...
                    {/* <div style={{display:"inline-block", width:"2px",backgroundColor:"#93120e", height:"2.5rem"}}></div> */}
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" data-kt-menu-offset="12,0" className="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                        ...
                        <span className="menu-link">
                        <i className="bi bi-stack fs-2" style={{marginRight:".3rem", fontSize:".9rem"}}></i>
                            <Link to="/collections">
                                <span className="menu-title" style={{fontSize:"1.1rem"}}>Collections</span>
                            </Link>
                            <span className="menu-arrow d-lg-none"></span>
                        </span>
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" data-kt-menu-offset="12,0" className="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                        ...
                        <span className="menu-link">
                        <i className="bi bi-cash fs-2" style={{marginRight:".3rem", fontSize:".9rem"}}></i>
                            <Link to="/send-money"><span className="menu-title" style={{fontSize:"1.1rem"}}>Send Money</span></Link>
                            <span className="menu-arrow d-lg-none"></span>
                        </span>
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" data-kt-menu-offset="12,0" className="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                        ...
                        <span className="menu-link">
                        <i className="bi bi-tv fs-2" style={{marginRight:".3rem", fontSize:".9rem"}}></i>
                            <Link to="/bills">
                                <span className="menu-title" style={{fontSize:"1.1rem"}}>Bills</span>
                            </Link>
